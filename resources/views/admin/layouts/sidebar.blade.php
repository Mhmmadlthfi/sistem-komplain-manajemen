<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ Request::is('aftersales/admin/dashboard') ? 'active open' : '' }}">
        ...
        @can('aftersalesOrManagerMarketing')
            ...
            <li class="menu-item {{ Request::is('aftersales/admin/complaint*') ? 'active open' : '' }}">
                <a href="{{ route('complaint.index', ['status' => 'Diterima']) }}" class="menu-link">
                    <i class='menu-icon tf-icons bx bx-archive-in'></i>
                    <div>Keluhan Masuk</div>
                </a>
            </li>
            <li class="menu-item {{ Request::is('aftersales/admin/handling*') ? 'active open' : '' }}">
                <a href="{{ route('handling.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-wrench"></i>
                    <div>Penanganan</div>
                </a>
            </li>
            <li class="menu-item {{ Request::is('aftersales/admin/resolved-complaint*') ? 'active open' : '' }}">
        ...
        @can('marketingOrManagerMarketing')
            ...
            <li class="menu-item {{ Request::is('aftersales/admin/sales*') ? 'active open' : '' }}">
            ...
            <!-- / Penjualan Barang -->
            <!-- Data Master -->
            <li class="menu-item {{ Request::is('aftersales/admin/master-data*') ? 'active open' : '' }}">
                <a href="javascript:void(0)" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-book-bookmark"></i>
                    <div data-i18n="Data Master">Data Master</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item {{ Request::is('aftersales/admin/master-data/customer*') ? 'active open' : '' }}">
                        <a href="{{ route('customers.index') }}" class="menu-link">
                            <div data-i18n="Data Customer">Data Customer</div>
                        </a>
                    </li>
                    <li class="menu-item {{ Request::is('aftersales/admin/master-data/product*') ? 'active open' : '' }}">
        ...
        @can('managerMarketing')
            ...
            <li class="menu-item {{ Request::is('aftersales/admin/manage-users') ? 'active open' : '' }}">
        ...
        @can('technicians')
            ...
            <li class="menu-item {{ Request::is('aftersales/admin/technician-handling*') ? 'active open' : '' }}">
                <a href="{{ route('technician-handling.index') }}" class="menu-link">
                    <i class='menu-icon tf-icons bx bx-wrench'></i>
                    <div>Penanganan</div>
                </a>
            </li>
            <li class="menu-item {{ Request::is('aftersales/admin/technician-history*') ? 'active open' : '' }}">
