...
@section('container')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Data Master / Data Customer /</span> Edit Data
        </h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="PLN X"
                                    value="{{ old('name', $customer->name) }}" autocomplete="name" required />
                                @error('name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="telp"
                                    ...
                                    placeholder="089384757384" name="telp" value="{{ old('telp', $customer->telp) }}"
                                    required />
                                @error('telp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
